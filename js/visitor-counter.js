        ...
        <div class="modal-card visitor-modal-card">
          ...
          <div class="visitor-modal-body">
            ...
            <div class="modal-actions-bar">
              <button class="btn-secondary" onclick="VisitorCounter.resetLocalData()">🔄 Reset My Visit History</button>
              <button class="btn-primary" onclick="closeModal('visitorStatsModal')">Close Analytics</button>
            </div>
          </div>
        </div>
      </div>
